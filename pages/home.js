        ...
        <div className="relative">
          <div id="hero" className="w-100 pb-20">
            <div className="page absolute mx-auto rounded hidden">
              <div className="page-inner relative h-full mb-12 text-center border border-lime-400 rounded-lg opacity-90">
                ...
                <div className="footer p-5 w-full">
                  <button className="w-full p-6 bg-lime-400 rounded uppercase tracking-wider text-lg">
                    Join the Army
                  </button>
                </div>
              </div>
